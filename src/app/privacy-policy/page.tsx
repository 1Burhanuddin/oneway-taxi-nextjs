                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <Card className="p-8 rounded-3xl border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl space-y-8 text-white/80 leading-relaxed">
                        <section>
                            ...
                            <p className="mb-4">
                                This Privacy Policy is a legally binding document between you and onewaytaxicabs.com Surat (both terms defined below). The terms of this Privacy Policy will be effective upon your acceptance of the same (directly or indirectly in electronic form, by clicking on the I accept tab or by use of the website or by other means) and will govern the relationship between you and Cab Book Karo.in for your use of the website “Website” (defined below).
                            </p>
                            <p className="mb-4">
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-yellow-400 mb-4">INFORMATION SECURITY</h2>
                            <p className="mb-4">
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-yellow-400 mb-4">GRIEVANCE REDRESSAL</h2>
                            <p className="mb-2">
                                Redressal Mechanism: Any complaints, abuse or concerns with regards to content and or comment or breach of these terms shall be immediately informed to the designated Grievance Officer as mentioned below via in writing or through email signed with the electronic signature.
                            </p>
                            <div className="mt-4 p-4 bg-white/10 rounded-xl">
                                <p className="font-semibold text-white">www.onewaytaxicabs.com</p>
                                <p>Company Name : Choice Taxi – Surat</p>
                                <p>Mobile: +91 85116 80364</p>
                            </div>
                        </section>
                    </Card>
                </div>
