      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-6">
            <Link href="/services" className="text-white/90 hover:text-yellow-400 transition-colors font-medium drop-shadow">
              Services
            </Link>
            <Link href="/about" className="text-white/90 hover:text-yellow-400 transition-colors font-medium drop-shadow">
              About
            </Link>
            <Link href="/contact" className="text-white/90 hover:text-yellow-400 transition-colors font-medium drop-shadow">
              Contact
            </Link>
            <Link href="/login" className="text-white/90 hover:text-yellow-400 transition-colors font-medium drop-shadow">
              Login
            </Link>
          </nav>
          ...
          <div className="hidden lg:flex items-center gap-4">
            <div className="text-right">
              <p className="text-sm font-semibold text-white drop-shadow">+91 85116 80364</p>
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-white/10 backdrop-blur-xl bg-black/90 rounded-b-2xl">
            <nav className="flex flex-col gap-4 px-4">
              ...
              <div className="pt-4 border-t border-white/10">
                <p className="text-sm font-semibold text-white mb-1 drop-shadow">+91 85116 80364</p>
